...
export default function Produtos(){
        ...
        const fetchData = async () => {
            ...
            try{
                ...
                const [resposta_1] = await Promise.all([
                    ...
                    fetch(`${config.URL_inicial_API}${DATAUser[0].id}/graficos/produtos/${URL_API}`)
    ...
    const navigation = useNavigation();
      ...
      const organiza_dados_grafico = () => {
        ...
        if(DATA != false){
            ...
            }else if(filtro == "qtd_comprados"){

                DATA.sort((a, b)=> b.qtd_comprados - a.qtd_comprados);
            ...
            valoresCopia.forEach((elemento, index) => {
                ...
                if(index > 8){
                    ...
                    qtd_comprados_total += elemento["qtd_comprados"];
            ...
            if(valoresCopia.length > 10){
                ...
                valores_9.push({
                    ...
                    qtd_comprados: qtd_comprados_total,
                    color: "#7986CB",
    ...
    function verifica_decimal(numero){

        const isApproximatelyInteger = (numero, epsilon = 0.009) => {
        ...
        if(Number.isInteger(numero)){
            ...
            if(isApproximatelyInteger(numero)){
                            ...
                            <View style={{flex: 3, justifyContent: "center"}}>
                                ...
                                <TouchableWithoutFeedback onPress={()=>{
                                    ...
                                    <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                                        ...
                                        <Text style={filtro == "qtd_comprados" ? {textAlign: "center", color: "#555", fontSize: 10, fontWeight: "bold"}:{textAlign: "center", color: "#888", fontSize: 10}}>
                            ...
                            <View style={{flex: 3, justifyContent: "center"}}>
                                ...
                                <TouchableWithoutFeedback onPress={()=>{
                                    ...
                                    <View style={{flexDirection: "row", justifyContent: "center", alignItems: "center"}}>
                                        ...
                                        <Text style={filtro == "quantidade" ? {textAlign: "center", color: "#555", fontSize: 10, fontWeight: "bold"}:{textAlign: "center", color: "#888", fontSize: 10}}>
                            ...
                            <View style={{flex: 4, justifyContent: "center"}}>
                                ...
                                <TouchableWithoutFeedback onPress={()=>{
                                    ...
                                    <View style={{flexDirection: "row", justifyContent: "flex-end", alignItems: "center"}}>
                                        ...
                                        <Text style={filtro == "valor_total" ? {textAlign: "right", color: "#555", fontSize: 10, marginEnd: 5, fontWeight: "bold"}:{textAlign: "right", color: "#888", fontSize: 10, marginEnd: 5}}>
                            ...
                            <View key={item.id} style={styles.linha_nomes}>
                                ...
                                <View style={[styles.linha_padrao, {flex: 3}]}>
                                    ...
                                    <Text style={{textAlign: "center", color: "#222"}}>
                                        ...
                                        {verifica_decimal(item.qtd_comprados)}
